            ...
            <CardContent className="p-6 h-[calc(100%-5rem)] overflow-auto">
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                onClick={() => navigator.clipboard.writeText(`POST ${apiEndpoint}`)}
                            >
                            ...
                            <div className="relative mt-2 space-y-2">
                                ...
                                <div className="flex justify-between items-center mt-2">
                                    ...
                                    <button
                                        ...
                                        onClick={() => navigator.clipboard.writeText(`Authorization: Bearer ${bearerToken}\nX-Request-ID: YOUR_REQUEST_ID`)}
                                    >
                                        <Copy className="w-4 h-4" />
                                    </button>
                                </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <pre className="bg-slate-100 p-4 rounded text-sm overflow-x-auto">
                                {showToken ? curlExample : curlExample.replace(bearerToken, "********")}
                            </pre>
                            <button
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <pre className="bg-slate-100 p-4 rounded text-sm overflow-x-auto">
                                {showToken ? fetchExample : fetchExample.replace(bearerToken, "********")}
                            </pre>
                            <button
                                className="absolute top-2 right-2 p-1 hover:bg-slate-200 rounded"
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside text-sm text-slate-600 space-y-1">
                            ...
                            <li><code className="text-slate-800">abort</code> - Client disconnection notification</li>
                        </ul>
                    </div>
                </div>
            </CardContent>
