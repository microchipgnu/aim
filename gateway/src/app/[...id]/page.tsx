                                        ...
                                        <div className="grid grid-cols-12 gap-8 flex-1 min-h-0 h-full">
                                                    ...
                                                    <Card>
                                                        ...
                                                        <CardContent>
                                                            <div className="space-y-4">
                                                                ...
                                                                <div className="text-sm text-muted-foreground">
                                                                    <span className="font-medium text-foreground">1.2k</span> Requests today
                                                                </div>
                                            ...
                                            <div className="col-span-12 lg:col-span-8 h-full">
                                                <Tabs defaultValue="overview" className="h-full flex flex-col">
                                                    ...
                                                    <TabsContent value="apis" className="mt-6 flex-1 min-h-0">
                                                        <ScrollArea className="h-full">
                                                            <Card>
                                                                <CardHeader>
                                                    ...
                                                    <TabsContent value="settings" className="mt-6 flex-1 min-h-0">
                                                        <ScrollArea className="h-full">
                                                            <Card>
                                                                <CardHeader>
