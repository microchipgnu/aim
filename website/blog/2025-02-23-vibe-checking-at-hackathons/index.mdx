...
<div style={{
  ...
  marginTop: '4rem',
    ...
    <audio 
        ...
        >
        <source 
            src="./audio/flawed-mangoes-killswitch-lullaby-slowed.mp3" 
            type="audio/mp3" 
        />
...
Following my presentation at ETHGlobal on Friday, February 14th, I received a direct message from [@kellykim](https://x.com/kellykim_xyz) inviting me to join another hackathon. I responded enthusiastically, “Sure, why not? I have less than 12 hours to build something, but I’m up for the challenge.”
