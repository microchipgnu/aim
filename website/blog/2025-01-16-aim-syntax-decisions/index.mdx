...
Twelve days have passed since my [last update](/blog/welcome), where I briefly introduced AIM as a potential solution for a new type of programming. In this post, I’ll walk you through the different syntax options I’ve been exploring and the decisions I’ve made along the way.
