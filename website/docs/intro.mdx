...
Hey there! If you made it here, you're probably interested in making your life easier *or just want to find something else to do with your time*.

**Either way, I'm glad you're here.**

I have started thinking about [Prompt-driven Programming](/blog/welcome) while ago and after a few weeks of drafting a solution, I'm finally ready to share it with you.
...
```markdown title="hello-world.aim"
Hello, World!
```
...
import {CodeSnippet} from '@site/src/pages/index';
