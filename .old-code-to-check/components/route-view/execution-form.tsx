import { AlertCircle, Edit2, PlayCircle, StopCircle } from 'lucide-react';
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              newInput.className =
                                'w-full focus-visible:ring-2 focus-visible:ring-primary/20 transition-shadow';
