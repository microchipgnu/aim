...
import type { DocumentError } from '../route-view';
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {errors.map((error, index) => (
                    <div
                      key={index}
                      className="text-sm p-3 bg-destructive/10 rounded-md text-destructive"
                    >
                      <div className="font-medium">
                        Error on lines {error.lines.join(', ')}
                      </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {warnings.map((warning, index) => (
                    <div
                      key={index}
                      className="text-sm p-3 bg-yellow-100/50 rounded-md text-yellow-800"
                    >
                      <div className="font-medium">
                        Warning on lines {warning.lines.join(', ')}
                      </div>
